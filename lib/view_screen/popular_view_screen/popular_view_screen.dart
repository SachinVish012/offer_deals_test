  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: RefreshIndicator(
        ...
        child: Obx(() {
          if (popularViewModel.isLoading.value && popularViewModel.deals.isEmpty) {
            return Center(
              child: CircularProgressIndicator(),
            );
          } else {
            return ListView.builder(
              itemCount: popularViewModel.deals.length + (popularViewModel.pagination.hasNextPage(popularViewModel.deals) ? 1 : 0),
